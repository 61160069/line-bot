...
$channelAccessToken = 'ZLuBBM5rRSE3lC/vDBCFhFOH6WLlOACI/VWOfuUJcFFAeOSaffZHWTprZ97SMSrLZmDppZ5Av307PL8H+jTmq5NCACSqYO1SwmK5Nziax4OcRlzP4jHPOQXo4RQ8wY+M1+uQsNvzJkIdsT/0XdtOZgdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
...
foreach ($request_json['events'] as $event)
{
	if ($event['type'] == 'message') 
	{
		if($event['message']['type'] == 'text')
		{
			...
			$reply_message = "Patcharapong";
			$reply_message = mySQL_selectAll('http://s61160069.kantit.com/json_select.php');
		} else {
